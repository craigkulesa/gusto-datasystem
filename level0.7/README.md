...
5. You're done!  Run the processor on some _current_ level 0.5 data (contemporary with this commit).  If you have everything set up in a config file, you can just run it without any arguments:
