...
def runGUSTO(verbose=False):
    ...
    if '0.7' in exlevels:
        print('Executing Level 0.7 pipeline: generating telemetry headers and making sequence files')
        n_files = L07_Pipeline(args)
        print('Level 0.7 to 0.8 done. ', n_files, ' files were processed.\n')
        print('#############################################################################')
        
    if '0.8' in exlevels:
        print('Executing Level 0.8 pipeline: channel flags for spurs and row flags for bad fringing')
        n_files = L08_Pipeline(args)
        print('Level 0.8 to 0.9 done. ', n_files, ' files were processed.\n')
        print('#############################################################################')
    ...
    if '1.0' in exlevels:
        ...
        print('Level 0.9 to 1.0 done. ', n_files, 'files were processed.\n')
        print('#############################################################################')
    print()
