...
2. Ensure you have already installed and configured influxdb for the level 0.5 processor, as it is also required for level 0.7.  See the Quick Start for Level 0.5 for instructions.  NOTE:  the influx database has changed in June 2025, so if you have an earlier version, please install the new one from the [calibration folder](http://soral.as.arizona.edu/GUSTO/calibration/).
